...
export interface ValidationProgress {
  ...
  status: "validating" | "repairing" | "completed" | "finalizing";
  /** 0-based. undefined = AI generation phase (not yet in validation loop) */
  currentPageIndex?: number;
  /** Total number of workflow trees/pages to validate */
  totalPages?: number;
}
